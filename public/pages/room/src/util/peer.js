class PeerBuilder {
    ...
    // Adicionar o comportamento de eventos de call também para quem ligar.
    ...
    _preparePeerInstanceFunction(peerModule) {
        ...
        PeerCustomModule.prototype.call = function(id, stream) {
            ...
            //aqui interceptamos o call e adicionamos todos os eventos da chamada para quem liga tambem
